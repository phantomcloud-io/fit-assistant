...
const (
	mangedMeals = "https://account.projectleannation.com/manage/meals"
	baseURL     = "https://account.projectleannation.com/login"
)

var (
	username = "bvanhou@gmail.com"
	password = "QTcxmtf2VSqzgEV"
)
